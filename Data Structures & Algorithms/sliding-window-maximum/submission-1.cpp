...
// Story Points:
// 1. When a new element comes nums[i], make space for it (window size can't be greater than k).
// 2. When nums[i] comes, there is no need to keep smaller elements in that window → pop them.
// 3. Push i into the deque → for nums[i].
